...
public class UpdateSystemPerformanceResourceHandler extends CoapResource
{
	...
	public void handleGET(CoapExchange context)
	{
		...
		context.respond(ResponseCode.CONTENT, "SystemPerformance Resource - GET OK", MediaTypeRegistry.TEXT_PLAIN);
	}
	...
	public void handlePUT(CoapExchange context)
	{
		...
		context.respond(code, "Update system perf data request handled: " + super.getName());
	}
